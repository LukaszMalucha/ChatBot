...
lines = file_io.FileIO('gs://churn-modelling-mlengine/data/movie_lines.txt', mode='r')
lines = open(lines, encoding = 'utf-8', errors = 'ignore').read().split('\n')

## list of converstions per movie
conversations = file_io.FileIO('gs://churn-modelling-mlengine/data/movie_conversations.txt', mode='r')
conversations = open(conversations, encoding = 'utf-8', errors = 'ignore').read().split('\n')
